...
pkgname=mtproxy-getpagespeed-git
pkgver=3.0.5.26f2ed
pkgrel=1
pkgdesc="Proxy server for Telegram messaging app"
arch=('i686' 'x86_64')
url='https://github.com/GetPageSpeed/MTProxy'
license=('GPLv2' 'LGPLv2')
depends=('curl' 'zlib')
source=(
    "$pkgname::git+https://github.com/GetPageSpeed/MTProxy.git"
    mtproxy.conf
...
md5sums=('SKIP'
         ...
         '4daec96c875993d413cad4952bcc80f3')
...
prepare() {
  ...
  patch --forward --strip=1 --input="$srcdir/engine.patch"
}
